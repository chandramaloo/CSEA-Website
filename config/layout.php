...
$maxPageWidth=1080; // max width of page in px
...
/* Tilegroup settings */
$groupTitles = array('Home','Events','Gallery','Feedback','Contact Us'); // titles of the tileGroups
$groupSpacing = array(6.5,6.5,6.5,6.5,6.5); // width of each tileGroup (spacing between the groups in tiles)
...
$groupInactiveOpacity = 0.5; // opacity of tiles that are not in the current tilegroup. 1 = full shown, 0.5 = transparent, can have any value between 0 and 1
...
/* Some behavior */
$scrollHeader = false; // wether the header should scroll with the page (true) or always stay visible (false)
